...
date: 2026-04-04T20:46:01-06:00
author: Jim McKeeth
layout: post
categories:
  - News
tags:
  ...
  - llm
  - markdown
image: /assets/images/2026/04/shell-script.avif
---
---

Do you remember the T-shirt "Stop bothering me, or I shall replace you with a very small shell script?" It perfectly expressed the frustration of working with useless people. Now I’m realizing it is our new reality. 

![Stop bothering me, or I shall replace you with a very small shell script](/assets/images/2026/04/shell-script-t-shirt.avif "Stop bothering me, or I shall replace you with a very small shell script")
...
I just recorded a podcast with Nick Hodges (stay tuned), he pointed out a fundamental truth: the backlog of software that needs to be built is gargantuan. We have a nearly infinite list of features and tools we want to implement, but we’ve always been bottle-necked by time and cost.
  ...
  ![Two football field's worth of backlog](/assets/images/2026/04/football_field_backlog.avif "Two football field's worth of backlog")  
### Agent Coding Changes the Math
...
The call went on as I continued explaining things that were already written down. While it only wasted an hour of time on the clock, the increase in my blood pressure wasted a couple more days of my life.  
...
When I gave those same instructions to an AI agent, it performed the task without complaining, without typos, and without needing a hand-holding session, and in much less than an hour. I didn't just automate a task; I literally replaced a frustrating human interaction with a shell script.

If you can't follow the Markdown, the AI will. And that is exactly how jobs will be replaced.
## *Postscript*

I wrote this a while ago, and I wasn't really happy with the way it ended. Makes me sound grumpier then I really am. I do love explaining things to people, *when they want to learn.* Certainly, if I'd been writing instructions for an end user I would would have been much more detailed. The existential threat of AI taking our jobs is real, but refusing to put even minimal effort to figure things out only makes matters worse.